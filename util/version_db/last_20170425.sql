...
-- Copiando dados para a tabela mm_bd.config: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.fisica_conta: ~3 rows (aproximadamente)
...
INSERT INTO `fisica_conta` (`id`, `fisica_id`, `tipo`, `valor`, `desconto`, `dt_cadastro`, `caixa_id`) VALUES
	(28, 2, 'D', 5.00, 0, '2017-04-20 13:34:32', 34),
	(29, 2, 'D', 5.00, 0, '2017-04-24 09:40:08', 34),
	(30, 2, 'D', 5.00, 0, '2017-04-24 09:41:40', 34);
...
-- Copiando dados para a tabela mm_bd.help: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.help_item: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `help_item` DISABLE KEYS */;
INSERT INTO `help_item` (`id`, `help_id`, `title_item`, `description_item`, `order_item`) VALUES
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~9 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.log: ~694 rows (aproximadamente)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`) VALUES
	...
	(27, '001', '', 3, 'Teste', '', 5.00, 1, 116, 105, 'y'),
	(32, '003', NULL, 3, 'Produto 2', NULL, 15.21, 1, NULL, 199, 'y'),
...
-- Copiando dados para a tabela mm_bd.venda: ~9 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.venda_pagto: ~9 rows (aproximadamente)
