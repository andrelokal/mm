...
-- Copiando dados para a tabela mm_bd.help: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~8 rows (aproximadamente)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`) VALUES
	...
	(27, '001', '', 3, 'Teste', '', 5.00, 1, 116, 104, 'y'),
...
-- Copiando dados para a tabela mm_bd.venda_pagto: ~8 rows (aproximadamente)
