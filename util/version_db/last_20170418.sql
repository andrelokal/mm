...
-- Copiando dados para a tabela mm_bd.acesso: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.caixa: ~12 rows (aproximadamente)
/*!40000 ALTER TABLE `caixa` DISABLE KEYS */;
INSERT INTO `caixa` (`id`, `valor_inicial`, `valor_fechamento`, `funcionario_id`, `dt_abertura`, `dt_fechamento`) VALUES
	(8, 54.21, 0.00, 1, '2017-03-29 09:18:28', '2017-03-29 09:43:52'),
	(9, 54.87, 0.00, 1, '2017-03-29 09:46:58', '2017-03-29 09:49:16'),
	(10, 454.87, 0.00, 1, '2017-03-29 09:55:04', '2017-03-29 09:55:30'),
	(11, 45.47, 0.00, 1, '2017-03-29 09:55:36', '2017-03-29 10:15:43'),
	(12, 4.57, 0.00, 1, '2017-03-29 10:17:10', '2017-03-29 10:17:19'),
	(13, 54.87, 15.20, 1, '2017-03-29 10:17:38', '2017-04-06 13:20:09'),
	(20, 15.20, 15.23, 1, '2017-04-06 13:22:11', '2017-04-06 13:23:14'),
	(21, 25.68, 4.57, 1, '2017-04-06 13:23:17', '2017-04-06 13:47:25'),
	(22, 5.98, 3.45, 1, '2017-04-06 13:47:56', '2017-04-04 22:51:22'),
	(23, 3.33, 0.02, 1, '2017-04-04 23:01:40', '2017-04-04 23:18:44'),
	(24, 2.32, 15.00, 1, '2017-04-04 23:19:53', '2017-04-08 14:55:11'),
	(25, 15.48, NULL, 1, '2017-04-08 14:55:24', NULL);
...
-- Copiando dados para a tabela mm_bd.fisica: ~14 rows (aproximadamente)
...
INSERT INTO `fisica_conta` (`id`, `fisica_id`, `tipo`, `valor`, `desconto`, `dt_cadastro`) VALUES
	(19, 2, 'D', 15.00, 0, '2017-04-08 11:42:54'),
	(21, 2, 'C', 5.00, 0, '2017-04-08 11:49:22'),
	(23, 2, 'C', 9.50, 5, '2017-04-08 11:55:27'),
	(24, 2, 'D', 10.00, 0, '2017-04-10 07:56:37'),
	(25, 2, 'C', 10.00, 0, '2017-04-11 09:28:44');
...
INSERT INTO `funcionario` (`id`, `nome`, `tipo_us`, `pessoa_id`, `login`, `senha`) VALUES
	(1, 'Ulisses', 'M', 1, 'ulisses', '0dd1219bf2c236a83bc362ffcdb02b50'),
	(3, '', 'N', 47, 'teste', '');
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.log: ~508 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.pessoa: ~16 rows (aproximadamente)
...
INSERT INTO `pessoa` (`id`, `status`, `tipo`, `rua`, `numero`, `bairro`, `cidade`, `uf`, `cep`, `pais`, `telefone`, `email`, `dt_atualizacao`, `dt_cadastro`) VALUES
	(1, 'AT', 'F', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2017-03-27 17:14:40', '2017-03-27 17:14:40'),
	...
	(47, 'AT', '', '', '', '', '', '', '', '', '', 'ulisses.bueno@gmail.com', '2017-04-18 10:53:56', '2017-04-18 10:53:56'),
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`) VALUES
	...
	(27, '001', '', 3, 'Teste', NULL, 5.00, 1, NULL, 124, 'y'),
...
-- Copiando dados para a tabela mm_bd.venda: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id`, `cliente_id`, `desconto`, `total`, `data`, `status`, `comanda_mesa_id`, `caixa_id`) VALUES
	(127, NULL, 0.00, 21.20, '2017-04-12 09:08:33', 'F', 1, 25),
	(128, NULL, 0.00, 14.86, '2017-04-12 09:10:05', 'F', 1, 25),
	(129, NULL, 0.00, 22.70, '2017-04-12 09:54:56', 'F', 1, 25),
	(130, NULL, 0.00, 37.26, '2017-04-12 15:09:32', 'F', 1, 25);
...
-- Copiando dados para a tabela mm_bd.venda_pagto: ~4 rows (aproximadamente)
