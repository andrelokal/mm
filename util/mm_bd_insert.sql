...
-- Copiando dados para a tabela mm_bd.caixa: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.categoria: ~1 rows (aproximadamente)
...
INSERT INTO `funcionario` (`id`, `tipo`, `pessoa_id`, `login`, `senha`, `email`) VALUES
	(1, 'N', 1, 'ulisses', '0dd1219bf2c236a83bc362ffcdb02b50', '');
...
-- Copiando dados para a tabela mm_bd.venda: ~5 rows (aproximadamente)
